  ...
  try {
    switch (req.method) {
      case "GET":
        ...
        const result = await EventController.getEventById(
          req as any,
          res as any
        );
      ...
      case "PUT":
        ...
        const updateResult = await EventController.updateEvent(
          authenticatedReq,
          res as any
        );
      ...
      case "DELETE":
        ...
        const deleteResult = await EventController.deleteEvent(
          authDeleteReq,
          res as any
        );
      ...
      case "PATCH":
        ...
        const authPatchResult = await authenticateUser(req, res);
        ...
        const patchResult = await EventController.publishEvent(
          authPatchReq,
          res as any
        );
